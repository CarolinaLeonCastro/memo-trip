...
// Palette de couleurs basée sur Material Design 3 et les wireframes
const theme = createTheme({
  palette: {
    ...
    text: {
      primary: '#293241', // Bleu très foncé pour le texte
      secondary: '#6C757D',
    },
    outline: {
      main: '#DEE2E6',
  ...
  components: {
    ...
    MuiButton: {
      styleOverrides: {
        ...
        contained: () => ({
          boxShadow: '0 2px 8px rgba(61, 90, 128, 0.24)',
          '&:hover': {
